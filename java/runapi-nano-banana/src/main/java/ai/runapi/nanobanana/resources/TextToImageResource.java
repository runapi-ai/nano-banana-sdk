package ai.runapi.nanobanana.resources;
...
public final class TextToImageResource extends NanobananaResource {
  /** API endpoint path for text to image operations. */
  public static final String ENDPOINT = "/api/v1/nano_banana/text_to_image";
