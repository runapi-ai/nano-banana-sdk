...
import ai.runapi.nanobanana.types.TextToImageResponse;
    ...
    class NanoBananaLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/nano_banana/text_to_image", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (NanoBananaClient client =
            NanoBananaClient.builder()
                .apiKey("sk-test")
      ...
      CompletedTextToImageResponse response =
        ...
        assertEquals("/api/v1/nano_banana/text_to_image", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/nano_banana/text_to_image/task_local_123", captured.path);
